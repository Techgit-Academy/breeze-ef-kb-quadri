export const ARTICLES = {
  "C1.1.1": {
    ...
    "errors": [
      {
        "msg": "You do not meet the minimum expected time in company",
        "fix": "You need at least one more consecutive salary payment on the same account. Wait for the next payroll cycle and try again."
      },
      {
        "msg": "You do not meet the Maximum expected time in company",
        "fix": "Your account has been with the company longer than the product allows. Contact support — this needs to be reviewed manually."
      },
      {
        "msg": "BVN is mandatory",
        "fix": "Your BVN is not linked or has become unlinked. Go to Profile → Verification to re-link it."
      }
    ],
  ...
  "C1.1.2": {
    ...
    "errors": [
      {
        "msg": "Unable to verify. You are not eligible for this loan. Kindly contact support",
        "fix": "One or more eligibility criteria are not met. Work through the checklist above and contact support if you cannot identify the reason."
      },
      {
        "msg": "You do not meet the minimum expected time in company",
        "fix": "You need more consecutive salary payments on the same account. Wait for the next payroll cycle."
      }
    ],
  ...
  "C1.2.3": {
    ...
    "errors": [
      {
        "msg": "OTP expired",
        "fix": "Each OTP is valid for a limited time. If it expires, tap Resend OTP once and wait 60 seconds."
      }
    ],
  ...
  "C1.2.6": {
    ...
    "errors": [
      {
        "msg": "Unable to complete process. Please try again",
        "fix": "This usually means the BVN consent step with NIBSS failed. Close the app, reopen on Wi-Fi, and try again. If it persists, contact support with your employee ID."
      },
      {
        "msg": "BVN consent required",
        "fix": "You need to give consent for your BVN to be used for the mandate. Tap Start Now on the consent screen. If you get an error after tapping, close and reopen the app."
      }
    ],
  ...
  "C2.1.1": {
    ...
    "errors": [
      {
        "msg": "Payment status showing Processing with no update for 4+ hours",
        "fix": "Check individual employee statuses, wallet balance, and whether other companies are affected. Follow the steps above."
      },
      {
        "msg": "Unable to re-initiate payment — status not updated to Failed",
        "fix": "Contact support to manually fail the stuck payment. Provide the batch number and reference number."
      },
      {
        "msg": "Failed payments due to Monnify or Moniepoint downtime",
        "fix": "This is a third-party gateway issue. Support will monitor and retry when service is restored. Do not initiate a new payment batch."
      }
    ],
  ...
  "C2.1.4": {
    ...
    "errors": [
      {
        "msg": "Employee whose payment status showed Failed was credited twice",
        "fix": "Always confirm with the employee whether they received the money before retrying a Failed status payment. This is the most common cause of duplicates."
      }
    ],
  ...
  "C2.2.2": {
    ...
    "errors": [
      {
        "msg": "Payment status showed completed but employee did not receive pension",
        "fix": "The payment left Breeze but was rejected at the PFA level. This usually means the RSA number is incorrect. Verify RSA details and contact support."
      },
      {
        "msg": "PFA verification failed",
        "fix": "The PFA details on file do not match the PFA's records. Update the employee's PFA information and resubmit."
      }
    ],
